...
class bot(object):
    ...
    API_ID: str = os.environ.get("23678651")
    API_HASH: str = os.environ.get("a1bcb2e0191095a0758e29280cf55933")

    # add API_TOKEN from @botfather (Mandatory)
    API_TOKEN: str = os.environ.get("7518391104:AAGR97S_pwer2qVP0OGHh_0KJ8GVv3Nlcic")
